...
# Add search string for the System Information tool
TxString = TxString + 'system inf' # Search string for the System Information tool
...
draw.text((0, 0), ControlCodes + ':' + 'Open System Information',fill = 'black', font = font)
