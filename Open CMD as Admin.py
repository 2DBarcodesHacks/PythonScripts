...
# Add commands to open a command-line window as the administrator
TxString = (TxString + 
            'Start-Process cmd -Verb RunAs'+Enter+ # Enter the command to open the command-line window as the administrator
...
draw.text((0, 0), ControlCodes + ':' + 'Open CMD as admin',fill = 'black', font = font)
